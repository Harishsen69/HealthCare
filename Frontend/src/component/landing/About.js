        ...
        <div className="ab-about-container">
            ...
            <section className="ab-hero-section">
                <div className="ab-hero-content">
                    <div className="ab-hero-text">
                        ...
                        <p>With 15+ years of excellence in healthcare, we combine modern medical technology with compassionate care to serve you better. Your well-being is our top priority.</p>
            ...
            <section className="ab-stats-section">
                <div className="ab-stats-grid">
                    <div><div className="ab-stat-num">500+</div><div className="ab-stat-label">Beds Available</div></div>
                    <div><div className="ab-stat-num">50+</div><div className="ab-stat-label">Specialities</div></div>
                    <div><div className="ab-stat-num">100+</div><div className="ab-stat-label">Ambulance Fleet</div></div>
                    <div><div className="ab-stat-num">98%</div><div className="ab-stat-label">Patient Satisfaction</div></div>
                </div>
            </section>
                    ...
                    <div className="ab-who-grid">
                        <div className="ab-who-content">
                            ...
                            <div className="ab-who-features">
                                <div className="ab-feature"><span>✓</span> NABH Accredited Hospital</div>
                                <div className="ab-feature"><span>✓</span> ISO Certified Labs</div>
                                <div className="ab-feature"><span>✓</span> Advanced ICUs</div>
                                <div className="ab-feature"><span>✓</span> Modern Operation Theatres</div>
                            </div>
                        </div>
                        <div className="ab-who-image">
                            <img src="https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=500&h=400&fit=crop" alt="Doctors Team" />
                ...
                <div className="ab-container">
                    ...
                    <div className="ab-mission-grid">
                        <div className="ab-mission-card">
                            ...
                            <h3>Our Mission</h3>
                            <p>To provide accessible, high-quality healthcare services with compassion, integrity, and advanced medical technology for every patient who walks through our doors.</p>
                        </div>
                        <div className="ab-vision-card">
                            <div className="ab-vision-icon">👁️</div>
                            <h3>Our Vision</h3>
                            <p>To become India's most trusted healthcare network, recognized for excellence in patient care, medical innovation, and community wellness.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="ab-testimonials-section ab-fade-up">
                <div className="ab-container">
                    ...
                    <div className="ab-testimonials-grid">
                        {[
                            { quote: "Excellent doctors and staff. My surgery was successful and recovery was smooth. Highly recommended!", name: "Rajesh Kumar", rating: "⭐⭐⭐⭐⭐" },
            ...
            {/* CTA + Footer Wrapper */}
            <div className="ab-cta-footer-wrapper">
                {/* CTA Section */}
                <section className="ab-cta-section">
                    <div className="ab-cta-content">
                        ...
                        <button className="ab-cta-btn" onClick={() => setPage("services")}>Get Started Now →</button>
                    </div>
                </section>
                ...
                <footer className="ab-footer">
                    <div className="ab-footer-inner">
                        <div className="ab-footer-grid">
                            <div>
                                <div className="ab-footer-logo">🏥 MediCare</div>
