...
urlpatterns = [
    ...
    # ========== DOCTORS (Protected - Admin & Doctor) ==========
    path('doctors/<int:id>/update/', views.update_doctor_profile, name='update_doctor_profile'),
    ...
    # ✅ NEW: Admin Delete Doctor
    path('admin/doctors/<int:id>/delete/', views.admin_delete_doctor, name='admin_delete_doctor'),
    ...
    # ========== APPOINTMENT NAME UPDATE ==========
path('update-appointment-names/', views.update_appointment_names, name='update_appointment_names'),
]
